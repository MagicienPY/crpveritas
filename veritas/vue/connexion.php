        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class=" col-md-10 offset-md-1">
                    <form id="request" class="main_form" action="" methode = "post" >
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input class="contactus" placeholder="passeword" type="password" name="password">
                            </div>
                            <p>i dont have account <a href="inscription.php"> i whant to create !</a></p>
                            <div class="col-md-12">
                                <button class="send_btn">Start trading</button>
                            </div>
                        </div>
                    </form>
                </div>
